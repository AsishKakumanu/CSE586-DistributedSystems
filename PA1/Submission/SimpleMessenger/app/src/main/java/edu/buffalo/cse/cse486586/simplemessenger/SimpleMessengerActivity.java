...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            /* Create a Server Socket on Specified Port 10000 */
            ServerSocket serverSocket = new ServerSocket(SERVER_PORT);

            /* Run ServerTask on the server socket created above using executeOnExecutor and Thread Pool Executor
             * which are typically used to run tasks parallel
             */
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try{
                ...
                while(true){
                    ...
                    /* If the Message is not null, Publish the message to the Main Activity
                     * while the Background Computations are still Running
                     */
                    if(message != null){
                        /// publishing Message
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /*
                 * Printing an Output Stream of bytes to text-output stream through the specified socket.
                 */
                ...
                /* Closing PrintWriter Stream and release any system resources associated along with it.
                 * Closing the Socket and discard / stop data waiting to be sent.
                 */
